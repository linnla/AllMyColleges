...
//  AllMyColleges
//
//  Created by Laure Linn on 10/13/11.
...
@synthesize savedScrollPosition, backButton, SectionHeaderHeight;
...
- (void)segmentAction:(id)sender
{
    ...
    if (index == 0) {
        ...
        NSString *parentViewColtroller = @"Search";
...
- (void) readUserDefaults {
    ...
    if ([self.textDetailString isEqualToString: @"studentPercent"]){
        self.sortString = @"alpha";
        self.textDetailString = @"cityState";
...
- (void) fetchColleges
{
    ...
    if (sortString == @"cost"){  
        ...
        self.searchKey = @"collegeNameOriginal";
        self.detailedLabelTextKey = textDetailString;
...
- (void) actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex 
{
   ...
   // } else if (buttonIndex == 1) {
     //   [defaults setObject:@"cost" forKey:@"sortField"];
       // [defaults setObject:@"studentTotalCostS" forKey:@"textDetailString"];
    } else if (buttonIndex == 1) {
        [defaults setObject:@"rank" forKey:@"sortField"];
        [defaults setObject:@"cityState" forKey:@"textDetailString"];
    } else if (buttonIndex == 2) {
        [defaults setObject:@"state" forKey:@"sortField"];
        [defaults setObject:@"city" forKey:@"textDetailString"];
    } 
